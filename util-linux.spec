...
Patch5:      Do-not-excute-Utmp-testcases.patch

Patch6:      backport-libfdisk-add-partition-type-aliases-and-shortcuts.patch
Patch7:      backport-fdisk-add-support-for-parttype-aliases.patch
Patch8:      backport-lib-strutils-fix-floating-point-exception.patch
Patch9:      backport-libfdisk-script-make-sure-label-is-specified.patch
Patch10:     backport-libfdisk-script-don-t-use-sector-size-if-not-specifi.patch
Patch11:     backport-libfdisk-fix-typo-from-255f5f4c770ebd46a38b58975bd33.patch
Patch12:     backport-libfdisk-make-fdisk_partname-more-robust.patch
Patch13:     backport-libfdisk-another-parse_line-nameval-cleanup.patch
Patch14:     backport-libfdisk-script-fix-possible-memory-leaks.patch
Patch15:     backport-libfdisk-script-fix-possible-partno-overflow.patch
Patch16:     backport-libmount-fix-tab-parser-for-badly-terminated-lines.patch
Patch17:     backport-clang-tidy-fix-wrong-cmp-usage.patch
Patch18:     backport-libblkid-improve-debug-for-proc-partitions.patch
Patch19:     backport-libblkid-use-sys-to-read-all-block-devices.patch
...
%{_bindir}/{setsid,setterm,taskset,ul,unshare,utmpdump,uuidgen,uuidparse,wdctl,whereis,scriptlive,hardlink}
...
* Sun Nov 28 2020 yangzhuangzhuang <yangzhuangzhuang1@huawei.com> - 2.35.2-2
- Type:enhancement
- ID:NA
- SUG:NA
- DESC:have wall not write to non-ttys(#65412)
       Do not excute Utmp testcases
